...
CONSTRAINT fk_ID_USUARIO FOREIGN KEY (ID_USUARIO) REFERENCES A_CLIENTES(ID));

CREATE TABLE A_CARRITO_PRODUCTO (
CARRITO NUMBER NOT NULL ,
PRODUCTO NUMBER NOT NULL,
CANTIDAD NUMBER NOT NULL,
CONSTRAINT fk_ID_CARRITO FOREIGN KEY (CARRITO) REFERENCES A_CARRITO(ID_CARRITO),
CONSTRAINT fk_ID_CANTIDAD FOREIGN KEY (PRODUCTO) REFERENCES A_PRODUCTOS(CODIGO_BARRAS));
