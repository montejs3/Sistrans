...
import uniandes.isis2304.parranderos.negocio.Aforandes;
import uniandes.isis2304.parranderos.negocio.Parranderos;
import uniandes.isis2304.parranderos.negocio.VOEmpleado;
...
//			e.printStackTrace();
    ...
    public void rfuno( )
    {
    	try 
    	{
    		...
    		if (nombre != null )
    		{
        		VOEmpleado tb = parranderos.adicionarEmpleado(nombre, pata, tipo, supermercado);
...
//			e.printStackTrace();
    ...
    public void rfdos( )
    {
    	try 
    	{
    		...
    		if (nombre != null )
    		{
        		VOEmpleado tb = parranderos.adicionarEmpleado(nombre, pata, ciudad, supermercado);
        		System.out.println(tb);
        		if (tb == null)
        		{
        			throw new Exception ("No se pudo crear un empleado con nombre: " + nombre);
