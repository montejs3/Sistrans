...
class SQLEmpleado 
{
	 ...
	 */
	public long adicionarEmpleado (PersistenceManager pm,int  cedula , String nombre , String tipo, String NOMBRESUPERMERCADO) 
	{
		
        Query q = pm.newQuery(SQL, "INSERT INTO " + pp.darTablaEmpleado  () + "(nombre, cedula,tipo,NOMBRESUPERMERCADO ) values (?, ?, ?, ?)");
